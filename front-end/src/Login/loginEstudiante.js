...
import './login.css';
import estudiante from '../docente/components/assets/estudiante.jpg';
    ...
    <div class="container-fluid ps-md-0">
        <div class="row g-0">
              ...
              <div class="container">
                ...
                <div class="row">
                  <div class="col-md-9 col-lg-8 mx-auto">
                    <h3 class="login-heading mb-4">Inicio de Sesión Estudiante</h3>
          ...
          <div className="d-none d-md-flex col-md-4 col-lg-6">
            <img className="img-fluid w-100"  src={estudiante} />
          </div>
        </div>
